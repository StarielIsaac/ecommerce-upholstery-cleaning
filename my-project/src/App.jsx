      ...
      >
        <header className="fixed top-0 left-0 bg-slate-800 py-2 px-4 md:px-8 flex justify-between items-center w-full z-50">
          ...
          >
            <a
              href="#home"
              className="text-white text-lg group relative focus:text-gray-200 flex items-center transition-colors hover:text-blue-300"
            >
      ...
      >
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 gap-8 px-4 md:px-8">
          ...
          >
            <FaWhatsapp
              size={32}
              className="text-blue-600 mb-2 animate-bounce"
          ...
          >
            <FaInstagram
              size={32}
              className="text-pink-600 mb-2 animate-bounce"
          ...
          >
            <IoMdPhonePortrait
              size={32}
              className="text-green-600 mb-2 animate-bounce"
